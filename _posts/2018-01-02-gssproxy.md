...
> WARNING: The native Kerberos does not work in latest Oracle JDK (JKD8u121 and upstream JDK9) with GS2-* SASL mechanisms - you can use following patch to make this working in (jdk9) OpenJDK:
>
...
Just note that workaround is not available for GS2-* SASL mechanisms, which does not work because of [JDK-8194630](https://bugs.openjdk.java.net/browse/JDK-8194630) too - affected channel binding cannot be ommited for GS2-* mechanisms.
